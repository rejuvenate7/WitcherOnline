...
class MP_SU_Oneliner {
  ...
  function register() {
    var manager: MP_SUOL_Manager;

    manager = MP_SUOL_getManager();
  ...
  public function setRenderDistance(value: int): MP_SU_Oneliner {
    this.render_distance = value;

    return this;
  }

  public function setText(value: string): MP_SU_Oneliner {
    this.text = value;

    return this;
  }

  public function setOffset(value: Vector): MP_SU_Oneliner {
    this.offset = value;

    return this;
  }

  public function setTag(value: string): MP_SU_Oneliner {
    this.tag = value;
  ...
  function getScreenPosition(hud: CR4ScriptedHud, out screen_position: Vector): bool {
    ...
    result = MP_SUOL_worldToScreenPosition(hud, world_position, screen_position);
